...
#write a subheader     
st.markdown("<h2 style='text-align: center;  font-size: 16px; margin-bottom: 30px'>Time Series Analysis on National Grid ESO Generation Data (2009 - 2024)</h2>",
...
fig.update_layout(title={'text': f'UK Energy Mix in {year_to_forecast} <br><span style="font-size: 18px; font-style: italic;"> (assuming static 2023 generation for non-wind energy sources)</span>', 
                         ...
                         annotations=[
                             ...
                             textangle=0, align='center')], width=850, height=750,
